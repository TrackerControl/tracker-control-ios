...
const iosSignatureAliases = {
  ...
  'adtiming': { name: 'AdTiming', country: 'CN', root_parent: null, parent: null },
  'bidmachine': { name: 'BidMachine', country: 'US', root_parent: null, parent: null },
  'dynatrace': { name: 'Dynatrace', country: 'US', root_parent: null, parent: null },
  'rollbar': { name: 'Rollbar', country: 'US', root_parent: null, parent: null },
  'tappx': { name: 'Tappx', country: 'ES', root_parent: null, parent: null },
  'uxcam': { name: 'UXCam', country: 'US', root_parent: null, parent: null },
  'mparticle': { name: 'mParticle', country: 'US', root_parent: 'Rokt', parent: 'Rokt' },
};
