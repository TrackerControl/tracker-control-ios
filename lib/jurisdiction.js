...
const sovereigntyNotes = {
  ...
  mixed_with_us_cn: 'This app\'s tracking data flows to both US and Chinese companies. US-based trackers are subject to the CLOUD Act; Chinese-based trackers are subject to China\'s PIPL and DSL, both of which permit government access to data. This app is subject to the most expansive government data access regimes.',
