...
// Names like "AdID access" and "Get device information" are Apple system APIs,
// not third-party trackers — mapped to Apple. "SKAdNetwork" is Apple's attribution API.
const iosSignatureAliases = {
  'adid access': { name: 'Apple', country: 'US', root_parent: null, parent: null },
  'get device information': { name: 'Apple', country: 'US', root_parent: null, parent: null },
